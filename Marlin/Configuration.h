...
#define STRING_CONFIG_H_AUTHOR "bisiler" // Who made the changes.
...
#define DEFAULT_AXIS_STEPS_PER_UNIT   {80,80,4000,101}  // default steps per unit for Ultimaker      80 80 4000 101 (32 microstepping + 1.8 degree stepper motor)
#define DEFAULT_MAX_FEEDRATE          {500, 500, 3, 100}    // (mm/sec)
#define DEFAULT_MAX_ACCELERATION      {500,500,1,100}    // X, Y, Z, E maximum start speed for accelerated moves. E default values are good for Skeinforge 40+, for older versions raise them a lot.

#define DEFAULT_ACCELERATION          300    // X, Y, Z and E acceleration in mm/s^2 for printing moves
#define DEFAULT_RETRACT_ACCELERATION  75    // E acceleration in mm/s^2 for retracts
...
#define LCD_FEEDBACK_FREQUENCY_DURATION_MS 1 // the duration the buzzer plays the UI feedback sound. ie Screen Click
